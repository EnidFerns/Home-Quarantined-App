...
namespace Mini_Project_1
{
    public partial class FormAdminHospitals : Form
    {
        ...
        private void FormAdminHospitals_Load(object sender, EventArgs e)
        {
            try
            {
                OleDbConnection con = new OleDbConnection("Provider = Microsoft.ACE.OLEDB.12.0; Data Source = 'C:\\HomeQuarantinedApp.xlsx'; Extended Properties = Excel 12.0;");
                con.Open();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            OleDbConnection con1 = new OleDbConnection("Provider = Microsoft.ACE.OLEDB.12.0; Data Source = 'C:\\HomeQuarantinedApp.xlsx'; Extended Properties = Excel 12.0;");
            con1.Open();
